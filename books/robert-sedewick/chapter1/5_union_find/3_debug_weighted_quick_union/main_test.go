package debug_weighted_quick_union
...
func Test(t *testing.T) {
	qf := union_find.NewWeightedQuickUnion(10)
	...
	require.Equal(t, []int{9, 7, 7, 9, 3, 7, 6, 7, 5, 7}, qf.Debug().ID)
	require.Equal(t, 34, qf.Debug().IDAccesses)
